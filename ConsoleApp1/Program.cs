...
//// Task 1. Yaşı 36 ilə 46 arasında olan borcluları göstərin
//var result = from d in debtors
//             let age = DateTime.Now.Year - d.BirthDay.Year
//             where age >= 36 && age <= 46
//             group d by age into AgeGroup
//             select AgeGroup;
...
//// Task  2. Borcu 5000-dən çox olmayan borcluları göstərin
//var result1= from d in debtors
//             where d.Debt<5000
//             select d;
...
//// Task   3. Adı 'A' hərfi ilə başlayan borcluları göstərin
//var result2 = from d in debtors
//              where d.FullName[0] == 'A'
//              select d;
...
//// Task    4. Qışda doğulan borcluları göstərin﻿
//var result2 = from d in debtors
//              where d.BirthDay.Month ==1 || d.BirthDay.Month ==2 || d.BirthDay.Month ==12
//              select d;
